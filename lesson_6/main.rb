...
#{}r1 = Route.new('кисловодск', 'москва')
#{}p r1
Task.new.main_menu
#{}t1 = PassengerTrain.new("027-мс", "123456")
#{}t1.class.superclass
#{}c2 = CargoTrain.new("320-гр", "кавказкая")
#{}p c2
#{}s1 = Station.new("ессентуки")
#{}p s1
#{}c3 = CargoTrain.new('гр123', "Товарный  - 3")
#{}p CargoTrain.instance_count
#{}p PassengerTrain.instance_count
